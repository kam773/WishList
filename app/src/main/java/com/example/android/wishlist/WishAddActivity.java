...
public class WishAddActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.fab) public void onClickSave() {
    ...
    @OnClick(R.id.buttonAddPhoto) public void onClickAddPhoto() {
        if(ContextCompat.checkSelfPermission(WishAddActivity.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(WishAddActivity.this,
                    new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 123);

        } else {
            EasyImage.openChooserWithGallery(WishAddActivity.this, "Select source", 0);
